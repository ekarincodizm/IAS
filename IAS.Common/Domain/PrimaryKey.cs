...
namespace IAS.Common.Domain
{
    ...
    public class PrimaryKey<TId1, TId2, TId3, TId4, TId5, TId6, TId7, TId8, TId9, TId10>
    {
        ...
        public override string ToString()
        {
            ...
            keies.Append("Id8:" + Id8.ToString());
            keies.Append("Id9:" + Id9.ToString());
            keies.Append("Id10:" + Id10.ToString());
            return keies.ToString();
        }
    }
}
