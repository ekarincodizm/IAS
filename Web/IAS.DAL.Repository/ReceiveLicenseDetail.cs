...
{
    [Serializable]
    public class ReceiveLicenseDetail  //  AG_IAS_LICENSE_D_TEMP
    {
        public UploadHeader Header { get; set; }
        public IEnumerable<AttachFileDetail> AttachFileDetails { get; set; }
