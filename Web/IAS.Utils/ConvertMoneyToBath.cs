...
namespace IAS.Utils
{
    public static class ConvertMoneyToBath
    {

        public static string ConvertMoneyToThai(string Amt)
        {
            string[] NumberWord;
            string[] NumberWord2;
            string Num3 = "";
            ...
            if (NumberWord.Length > 1)
            {
                ...
                {
                    ProcessValue = ProcessValue + Resources.propConvertMoneyToBath_001 + SplitWord(NumberWord[1]) + Resources.propConvertMoneyToBath_002;
                }
                else
                {
                    ProcessValue = ProcessValue + Resources.propConvertMoneyToBath_003;
                }
            }
            else
            {
