...
{
    public partial class ReplacementReport : basepage
    {
        ...
        protected void SetReplacement()
        {
                ...
                tempItem.Add(new DTO.DataItem { Id = "01", Name = "ใบแทนที่เสียค่าธรรมเนียม" }); 
                tempItem.Add(new DTO.DataItem { Id = "02", Name = "ใบแทนที่ไม่เสียค่าธรรมเนียม" }); 
                tempItem.Add(new DTO.DataItem { Id = "00", Name = "ทั้งหมด" }); 
                BindToDDL(ddlReplacement, tempItem.ToArray());
                ddlReplacement.Items.Insert(0, "---- เลือก ----");
        }
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Session["ReplaceName"] = ddlReplacement.SelectedItem.Text.Trim();
            string PetitionType = ddlLicenseType.SelectedValue.Trim();
            string CompCode = ddlCompany.SelectedValue.Trim();
            string Replacement = ddlReplacement.SelectedValue.Trim();
